...
<s.Screen>
  <s.ScrollBar>
      <s.Container
        ...
        >
      <s.Container>
      <StyledImg alt={"example"} src={"https://github.com/rektcherry/webdeploy/blob/main/public/config/images/neon.png"} style = {{width:"100%", padding: "0px", position:"center"}} />
     <s.Container
    flex={1}
    ai={"center"}
    jc={"center"}
  ...
  <s.SpacerLarge/>
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 0 }} >
          <s.Container flex={1} jc={"center"} ai={"center"} style={{ padding:30}}>
            <StyledImg
              alt={"example"}
              src={"https://github.com/rektcherry/webdeploy/blob/main/public/config/images/glitch.jpg"}
              style={{ padding: 5 }}
            />
            </s.Container>
            <s.Container flex={1} jc={"center"} ai={"center"}style={{ padding:30}}>
            <StyledImg
              alt={"example"}
              src={"https://github.com/rektcherry/webdeploy/blob/main/public/config/images/lanes.jpg"}
              style={{ padding: 5 }}
            />
            </s.Container>
            <s.Container flex={1} jc={"center"} ai={"center"} style={{ padding:30}}>
            <StyledImg
              alt={"example"}
              src={"https://github.com/rektcherry/webdeploy/blob/main/public/config/images/venytys.jpg"}
              style={{ padding: 5 }}
            /> 
            </s.Container>
          </ResponsiveWrapper>
      ...
      <s.TextDescription
            ...
            <s.SpacerSmall/>
            <StyledImg alt={"example"} src={"https://github.com/rektcherry/webdeploy/blob/main/public/config/images/eth.gif"} style = {{width: "80px",  alignSelf: 'center' }} />
            <s.SpacerLarge/>
      </s.Container>
  <s.SpacerLarge/>
        <s.Container
